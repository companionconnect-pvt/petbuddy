  ...
  const handleSaveClick = async () => {
    try {
      ...
      if (editingField === "address") {
        const [street, city, state, zip] = editValue.split(",").map((part) => part.trim());
    ...
    <div className="p-6 md:p-10 bg-gray-50 min-h-screen">
      ...
      <div className="grid lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-6">
          <AnimatePresence>
            {renderEditableField("Full Name", "name", user.name, <FiUser size={20} />)}
            {renderEditableField("Email", "email", user.email, <FiMail size={20} />)}
            {renderEditableField("Phone", "phoneNumber", user.phoneNumber, <FiPhone size={20} />)}
        ...
        >
          ...
          {user.pets.length > 0 ? (
                    ...
                    <div className="flex-shrink-0">
                      <div className="h-14 w-14 rounded-full bg-gray-200 flex items-center justify-center overflow-hidden">
                        {pet.photo ? (
                          ...
                          <span className="text-gray-400 text-xl">{pet.name.charAt(0)}</span>
                        )}
                      </div>
                    </div>
                    <div className="flex-1 min-w-0">
                      <div className="flex justify-between items-start">
                        ...
                        <div className="flex space-x-2">
                          ...
                          >
                            <img src={binIcon} className="h-5 w-5 opacity-70 hover:opacity-100" alt="delete" />
                          </button>
                        </div>
                      </div>
                      <div className="mt-3 flex flex-wrap gap-2">
                        <span className="px-3 py-1 bg-blue-50 text-blue-600 text-xs rounded-full">Active</span>
            ...
            <div className="text-center py-12">
              ...
              <h4 className="text-lg font-medium text-gray-700 mb-2">No pets added yet</h4>
                ...
                >
                  ...
                  <div className="mt-4 flex justify-between items-center">
                    <div>
                      ...
                      <p className="font-medium">Dr. {booking.professional?.name || 'Not assigned'}</p>
                    </div>
